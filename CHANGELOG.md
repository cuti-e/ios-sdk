...
## [2.5.0](https://github.com/cuti-e/ios-sdk/compare/2.4.1...2.5.0) (2026-09-10)


### Features

* **analytics:** send the activity ping once per UTC day instead of once per process launch, so a backgrounded app that is resumed after midnight UTC is counted
* **analytics:** report activity ping outcomes — HTTP rejections and transport failures are counted and exposed via `CutiE.shared.activityPingDiagnostics` (and logged without any device identifier) instead of being discarded
...
* add configurable device context for activity pings and conversations ([#85](https://github.com/cuti-e/ios-sdk/issues/85)) ([8c3dd9f](https://github.com/cuti-e/ios-sdk/commit/8c3dd9fd43d9f5fdda59b943992e007352ce3163))
