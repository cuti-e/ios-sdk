...
```swift
dependencies: [
    .package(url: "https://github.com/cuti-e/ios-sdk.git", from: "1.0.100")
],
targets: [
    .target(
        name: "YourTarget",
...
> **Note:** API keys are no longer required. The SDK authenticates using your App ID and a device-specific token.
